...
- **Word Definition Requests**: Hebrew words you look up
- **Bible References**: Passages you access through Sefaria integration
- **Rate Limit Tracking**: Timestamps and counts of your API requests

## 2. How We Use Your Information

### To Provide the Service
- Authenticate your account and maintain your login session
- Store and retrieve your vocabulary lists and progress
- Generate personalized tests based on your learning history
- Provide translations and definitions through AI services
...
- Notify you of service updates or changes to Terms/Privacy Policy
- Respond to your support requests
- Send marketing emails (only if you opt in, with easy unsubscribe)
...
- Stores your account information, vocabulary, and progress data
- Provides secure authentication services
- Privacy Policy: https://supabase.com/privacy

**Google Gemini API** (AI Translation Service)
- Receives text you request to translate or define
- We cache translations to minimize repeated requests
- Privacy Policy: https://policies.google.com/privacy

**Sefaria.org** (Biblical Text Provider)
...
### Business Transfers
If we are acquired, merged, or sell assets, your information may be transferred to the new entity. We will notify you via email and/or a prominent notice on the Service.
...
- Your profile and vocabulary lists are deleted within 30 days
- Aggregated, anonymized statistics may be retained for analytics
- Backups may retain data for up to 90 days for disaster recovery
- We may retain certain data longer if required by law

### Cached Data
- **Translation Cache**: Automatically deleted after 30 days of inactivity
- **Sefaria Cache**: Cleaned up based on access patterns
- **Word Definition Cache**: No automatic expiration (can be manually cleared)
...
- Export your vocabulary lists and progress data
- Request a copy of your data in a portable format

### Correction and Deletion
You have the right to:
- Correct inaccurate information in your profile
- Delete individual vocabulary words or test results
...
### Your Continued Use
Continued use of the Service after changes constitutes acceptance. If you do not agree to changes, you must stop using the Service and delete your account.

## 11. Third-Party Links

The Service may contain links to third-party websites or services (e.g., Sefaria.org). We are not responsible for the privacy practices of these third parties. We encourage you to review their privacy policies before providing them with any information.
