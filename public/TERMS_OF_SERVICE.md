...
By accessing or using this Hebrew learning platform (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.

## 2. Description of Service

The Service provides Hebrew vocabulary learning tools, including:
- Vocabulary management and tracking
- Adaptive testing systems (flashcards, multiple choice, fill-in-blank)
- Hebrew text translations
- Word definitions with transliteration
- Bible passage translation and study tools
...
### Your Data
- You retain ownership of any vocabulary lists, notes, or content you create
- By using the Service, you grant us a license to store and process your data to provide the Service
...
### Our Rights
- The Service, including all software, designs, text, graphics, and other materials, is owned by us or our licensors
- You may not copy, modify, distribute, sell, or reverse engineer any part of the Service
- Our trademarks, logos, and branding may not be used without our prior written permission

### Third-Party Content
- Biblical texts are sourced from Sefaria.org and remain subject to their respective licenses
...
- Attempt to overwhelm our servers or disrupt service availability
...
- We implement rate limits to ensure fair usage and protect our infrastructure
- Current limits: 100 word definitions per hour, 30 translations per hour
- Exceeding rate limits may result in temporary service restrictions
- We reserve the right to adjust rate limits at any time
...
- WARRANTIES REGARDING THE ACCURACY, RELIABILITY, OR COMPLETENESS OF CONTENT OR TRANSLATIONS

### Educational Purpose Only
This Service is for educational purposes only. We do not guarantee:
- The accuracy of translations or definitions
- That using this Service will result in Hebrew language fluency
- That the Service is suitable for academic or professional certification
...
You agree to indemnify, defend, and hold us harmless from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising from:
...
### Binding Arbitration
YOU AGREE THAT ANY DISPUTE BETWEEN YOU AND US WILL BE RESOLVED THROUGH BINDING ARBITRATION, NOT IN COURT, except that you may assert claims in small claims court if they qualify.
...
### Class Action Waiver
YOU AGREE THAT DISPUTES MUST BE BROUGHT ON AN INDIVIDUAL BASIS ONLY, AND NOT AS PART OF ANY CLASS OR REPRESENTATIVE ACTION. You waive any right to participate in a class action lawsuit or class-wide arbitration.
...
- The Service integrates with third-party APIs (Sefaria, Google Gemini)
